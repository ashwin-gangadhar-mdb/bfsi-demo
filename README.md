...
* Load one time batch data incrementally to train model
 ...
 <img width="1901" alt="image" src="raw_txn.png">
 processed trainsaction in feature store
 <img width="1901" alt="image" src="txn_features.png">
...
Model Run Info
<img width="1901" alt="image" src="model_train_view.png">

Model Run Registry
<img width="1901" alt="image" src="model_registry.png">
...
<img width="1901" alt="image" src="rule_collection.png">

Rule Model Execution Flow
<img width="1901" alt="image" src="bfsi_rule_model_flow.drawio.png">
...
<img width="1686" alt="image" src="worflow1.png">

Streaming Worflow
<img width="1987" alt="image" src="worflow2.png">
...
1. transactions 
   ...
   <img width="738" alt="image" src="txn_stream_data.png">
...
2. processed transactions post feature transformation :
   ...
   <img width="688" alt="image" src="txn_featurized_view.png">
...
3. transaction status table :  
   ...
   <img width="655" alt="image" src="txn_status.png">
...
<img width="1515" alt="image" src="model_rest_endpoint_3.png">
...
<img width="1224" alt="image" src="atlas_trigger_fn.png">
